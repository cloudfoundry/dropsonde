...
type MetricSender interface {
	...
	SendContainerMetric(applicationId events.UUID, instanceIndex int32, cpuPercentage float64, memoryBytes uint64, diskBytes uint64) error
}
...
func (ms *metricSender) SendContainerMetric(applicationId events.UUID, instanceIndex int32, cpuPercentage float64, memoryBytes uint64, diskBytes uint64) error {
